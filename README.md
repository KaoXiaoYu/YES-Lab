...
招新管理支持多人面试官的线下面试场次、候选人预约/取消、固定顺序面试号、单人叫号、未到场移至队尾、面试结论及提前结束释放队列。正式成员可使用文字讨论板发帖、一级回复和点赞；互动、面试变更与结果均由站内机器人“梅琳娜”推送，多个新消息在前端折叠提示。成员没有手工发送站内消息的接口。
